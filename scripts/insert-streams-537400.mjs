// One-off: insert curated stream links for Jordan vs Algeria (match 537400).
...
const MATCH_ID = '537400';
const now = new Date().toISOString();

const links = [
  { label: 'D Sports', quality: 'HD', language: 'English', url: 'https://footsterss.pages.dev/?id=dsports' },
  ...
  { label: 'Sports TV', quality: 'HD', language: 'English', url: 'https://fifa26-live.pages.dev/?play=1&stream=5' },
  { label: 'beIN 50fps', quality: 'HD', language: 'English', url: 'https://fifa26-live.pages.dev/?play=1&stream=6' },
